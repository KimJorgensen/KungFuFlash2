/******************************************************************************
* Based on usbd_stm32f429_otghs.c and usbd_stm32f446_otghs.c
******************************************************************************/
...
static uint32_t getinfo(void) {
    if (!(RCC->AHB1ENR & RCC_AHB1ENR_USB1OTGHSEN)) return STATUS_VAL(0);
...
static void enable(bool enable) {
    if (enable) {
        ...
        _BST(RCC->AHB1ENR, RCC_AHB1ENR_USB1OTGHSEN);
