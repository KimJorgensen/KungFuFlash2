...
static u32 const ss5_mode[8] =
{
    ...
    STATUS_LED_ON|CRT_PORT_NONE|C64_IRQ_NMI_HIGH,
    STATUS_LED_ON|CRT_PORT_16K,
    STATUS_LED_ON|CRT_PORT_8K|C64_IRQ_NMI_HIGH,

    STATUS_LED_OFF|CRT_PORT_ULTIMAX,
    STATUS_LED_OFF|CRT_PORT_NONE|C64_IRQ_NMI_HIGH,
    STATUS_LED_OFF|CRT_PORT_16K,
    STATUS_LED_OFF|CRT_PORT_8K|C64_IRQ_NMI_HIGH
};
...
FORCE_INLINE bool ss5_read_handler(u32 control, u32 addr)
{
    ...
    {
        C64_CRT_CONTROL(C64_IRQ_NMI_LOW);
